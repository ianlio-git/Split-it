...
function Navbar() {
  ...
  // Renderiza el Navbar para todas las páginas, incluyendo Landing, Privacy, Terms, etc.
  return (
      ...
      <nav className="container mx-auto px-6 h-full flex justify-between items-center">
        ...
        <div className="space-x-2 md:space-x-4 flex items-center">
          {user ? (
            ...
            <Auth /> // Aquí se muestra el componente Auth en todas las rutas si el usuario no está autenticado
          )}
        </div>
      </nav>
    </header>
